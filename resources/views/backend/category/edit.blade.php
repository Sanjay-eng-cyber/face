                                    ...
                                    <select class="form-control" name="event_id" required>
                                        ...
                                        @foreach ($events as $event)
                                            <option value="{{ $event->id }}"
                                                {{ $category->event_id == $event->id ? 'selected' : '' }}>
                                                {{ $event->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-12 mt-2">
                                    ...
                                    <div class="radio-container">
                                        <input type="radio" id="yes" name="visibility" value="1"
                                            {{ old('visibility', $category->visibility) == 1 ? 'checked' : '' }} required>
                                        <label for="yes">Yes</label>
                                    </div>

                                    <div class="radio-container">
                                        <input type="radio" id="no" name="visibility" value="0"
                                            {{ old('visibility', $category->visibility) == 0 ? 'checked' : '' }} required>
                                ...
                                <div class="col-xl-6 col-md-6 col-sm-12 mt-2">
                                    ...
                                    <div class="radio-container">
                                        <input type="radio" id="yes" name="sharing" value="1"
                                            {{ old('sharing', $category->sharing) == 1 ? 'checked' : '' }} required>
                                        <label for="yes">Yes</label>
                                    </div>

                                    <div class="radio-container">
                                        <input type="radio" id="no" name="sharing" value="0"
                                            {{ old('sharing', $category->sharing) == 0 ? 'checked' : '' }} required>
                                        <label for="no">No</label>
                                    </div>
