                        ...
                        <form class="mt-3" method="POST" action="{{ route('backend.user.form-one-update', $users->id) }}"
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-12 col-md-6 mt-3 ">
                                    ...
                                    <input type="text" class="form-control" id="formGroupExampleInput3"
                                        placeholder="Enter Caste" value="{{ old('caste') ?? $users->caste }}"
                                        minlength="3" maxlength="30" required name="caste">
                                    @if ($errors->has('caste'))
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-check-inline d-block pt-1">
                                        ...
                                        @else
                                            <input class="form-check-input d-inline-block" type="radio" name="handicap"
                                                id="handicap_yes" value="1"
                                                @if ($users->handicap == '1') {{ 'checked' }} @endif @required(true)>
                                            <label class="form-check-label d-inline-block" for="handicap_yes">
                                                Yes
                                            </label>
                                            <input class="form-check-input d-inline-block" type="radio" name="handicap"
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group res-add">
                                        ...
                                        <textarea type="text" placeholder="Enter your Residential Address" name="residential_address"
                                            id="residential_address" class="form-control" rows="2" minlength="3" maxlength="120">{{ old('residential_address') ?? $users->residential_address }}</textarea>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="education" required>
                                            ...
                                            @else
                                                @foreach (App\Models\User::EDUCATION as $e)
                                                    <option value="{{ $e }}"
                                                        @if ($users->education == $e) {{ 'selected' }} @endif>
                                                        {{ $e }}
                                                    </option>
                                                @endforeach
                                            @endif
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="income">Income (PA)</label>
                                        <input type="text" name="income" id="income"
                                            placeholder="Enter your Income (PA)" class="form-control"
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="mobile" id="mobile"
                                            placeholder="Enter You Mobile No." class="form-control" minlength="10"
                                            maxlength="10" value="{{ old('mobile') ?? $users->mobile }}" disabled>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="mobile_number">No. of Married Sisters (Other than
                                            Candidate)</label>
                                        <input type="text" name="married_sisters" id="married_sisters"
                                            placeholder="Enter No. of Married Sisters" class="form-control"
                                            value="{{ old('married_sisters') ?? $users->married_sisters }}" required>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="mobile_number">No. of Unmarried Sisters (Other than
                                            Candidate)</label>
                                        <input type="text" name="unmarried_sisters" id="unmarried_sisters"
                                            placeholder="Enter No. of Unmarried Sisters" class="form-control"
                                            value="{{ old('unmarried_sisters') ?? $users->unmarried_sisters }}" required>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="married_brothers">No. of Married Brothers (Other than
                                            Candidate)</label>
                                        <input type="text" name="married_brothers" id="married_brothers"
                                            placeholder="Enter No. of Married Brothers" class="form-control"
                                            value="{{ old('married_brothers') ?? $users->married_brothers }}" required>
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    <div class="form-group">
                                        <label for="unmarried_brothers">No. of Unmarried Brothers (Other than
                                            Candidate)</label>
                                        <input type="text" name="unmarried_brothers" id="unmarried_brothers"
