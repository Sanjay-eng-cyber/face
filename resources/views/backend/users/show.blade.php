                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-xl-4 col-md-6">
                                            <div class="form-group">
                                                ...
                                                <form id="mt-3" action="{{ route('backend.user.status', $user->id) }}"
                                                    method="post" class="section work-experience"
                                        ...
                                        <div class="col-xl-4 col-md-3 col-6 mt-md-0 mt-3">
                                            <div class="form-group">
                                                ...
                                                <a href="{{ route('backend.user.print', $user->id) }}"
                                                    class="btn btn-primary mt-1"><img
                                                        src="{{ url('frontend/image/white-printer.png') }}"
                                                        alt="" width="20px"></a>
                                            </div>
                                        </div>
                ...
                <ul class="nav nav-tabs " id="simpletab" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="subscription-tab" data-toggle="tab" href="#subscription" role="tab"
                            aria-controls="subscription" aria-selected="false">Subscriptions</a>
                    </li>
                    {{-- <li class="nav-item">
