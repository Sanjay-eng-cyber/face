                ...
                <div class="col-md-12 col-lg-12">
                    <div class="statbox widget box box-shadow">
                        <form class="mt-3" method="POST" action="{{ route('backend.user.form-two-update', $users->id) }}"
                            ...
                            <div class="form-group mb-4 row">
                                ...
                                <div class="col-12 col-md-6 mt-3">
                                    ...
                                    <input type="text" name="reference_one_name" id="reference_one_name"
                                        ...
                                        value="{{ $userReferenceOne ? $userReferenceOne->name : '' }}" minlength="3" maxlength="30"
                                        required>
                                ...
                                <div class="col-12 mt-4 mb-0 px-0">
                                    <legend class="text-center h3">FAMILY DETAILS</legend>
                                </div>
                                <div class="col-12 col-md-6 mt-3">
                               ...
                               <div class="row justify-content-center">
                                <div class=" text-center mt-4 px-0">
                                    <legend class="text-center h3 mb-3">CANDIDATE'S SPECIAL CHOICE</legend>
                                </div>
                            ...
                            <input type="submit" class="btn btn-primary d-block mx-auto  mt-4 text-center" value="Submit"
