            ...
            <div class="statbox widget box box-shadow my-1">
                <div class="widget-header">
                    <div class="row justify-content-between align-items-center mt-2 px-3">
                        ...
                        <div class="col-12 col-md-6  d-flex justify-content-end align-it px-0">
            ...
            <div class="statbox widget box box-shadow">
                <div class="widget-content widget-content-area">
                    <div class="row layout-top-spacing">
                        <div class="col-xl-4 col-md-6 col-sm-12 col-12 layout-spacing mb-sm-2 mb-4">
