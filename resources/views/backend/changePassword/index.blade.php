                        ...
                        <form class="mt-3" method="POST" action="{{ route('cms.password.submit', $user->id) }}"
                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-md-4 col-12 mb-3">
                                    ...
                                    <select name="role" class="form-control" id="role-select" required>
                                        ...
                                        <option value="admin" @if (old('role') == 'admin' || $user->role == 'admin') {{ 'selected' }} @endif>
                                            Admin</option>
                                        <option value="super-admin"
                                            @if (old('role') == 'super-admin' || $user->role == 'super-admin') {{ 'selected' }} @endif>Super Admin
                                        </option>
                                    </select>
                                    @if ($errors->has('role'))
                            ...
                            <div class="form-group mb-3 row d-none" id="additional-fields">
                                <div class="col-md-4 col-12 mb-3">
                                    ...
                                    @if ($errors->has('plan'))
                                        <div class="text-danger" plan="alert">{{ $errors->first('role') }}
                                        </div>
                                    @endif
                                </div>
                                <div class="col-md-4 col-12 mb-3">
