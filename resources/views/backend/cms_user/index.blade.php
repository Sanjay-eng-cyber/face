                ...
                <div class="widget-header">
                    ...
                    <div class="row">
                        ...
                        <div
                            ...
                            <a href="{{ route('backend.cms-user.create') }}" name="txt"
                    ...
                    <div class="widget-content widget-content-area">
                        <div class="table-responsive min-height-20em">
                            <table class="table mb-4">
                                ...
                                <tbody>
                                    @forelse($cmsUsers as $cmsUser)
                                        <tr>
                                            <td>{{ tableRowSrNo($loop->index, $cmsUsers) }}</td>
                                            <td>{{ $cmsUser->name }}</td>
                                                ...
                                                <div class="dropdown custom-dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuLink1">
                                                        <a class="dropdown-item"
                                                            href="{{ route('backend.cms-user.show', $cmsUser->id) }}">View</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('backend.cms-user.edit', $cmsUser->id) }}">Edit</a>
                                                        <a class="dropdown-item"
                                                            href="{{ route('backend.cms-user.delete', $cmsUser->id) }}"
                                                            onclick="return confirm('Are you sure you want delete this Cms User?');">Delete</a>
                                                    </div>
                                                </div>
                        ...
                        <div class="pagination col-lg-12 mt-3">
                            <div class=" text-center mx-auto">
                                <ul class="pagination text-center">
                                    {{ $cmsUsers->appends(Request::all())->links('pagination::bootstrap-4') }}
                                </ul>
                            </div>
                        </div>
