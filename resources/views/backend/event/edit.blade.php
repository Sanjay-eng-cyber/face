                            ...
                            <div class="form-group mb-3 row">
                                ...
                                <div class="col-xl-6 col-12 mb-3">
                                    ...
                                    @else
                                        <input type="radio" id="original" name="upload_image_quality"
                                            value="original"
                                            @if ($event->upload_image_quality == 'original') {{ 'checked' }} @endif>
                                        <label for="original">Original</label>
                                        <input type="radio" id="compressed" name="upload_image_quality"
                                            value="compressed"
                                            @if ($event->upload_image_quality == 'compressed') {{ 'checked' }} @endif>
                                        <label for="compressed">compressed</label>
                                    @endif
                                ...
                                <div class="col-xl-6 col-12 mb-3">
                                    ...
                                    @else
                                        <input type="radio" id="link_sharingYes" name="link_sharing" value="1"
                                            @if ($event->link_sharing == '1') {{ 'checked' }} @endif>
                                        <label for="link_sharingYes">Yes</label>
                                        <input type="radio" id="link_sharingNo" name="link_sharing" value="0"
                                            @if ($event->link_sharing == '0') {{ 'checked' }} @endif>
                                        <label for="link_sharingNo">No</label>
                                    @endif
