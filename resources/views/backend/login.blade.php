...
<head>
    ...
    max-width: 442px;
        ...
        .form-control.bg-pink-color:focus{
            background-color: #FE3B96;
        }
...
<body class="auth-page-bg body-bg">
    {{-- <img src="{{ asset('backend/images/login/ele-login.svg') }}" alt="" srcset=""
        class="img-fluid position-absolute start-0 top-0"> --}}
    <div class="container h-100 d-flex  align-items-center">

        <div class="auth-form ">
            <div class="auth-form-inner-one">
                <div class="auth-form-inner">
                    <a href="{{ url('/') }}"> <img class="d-block mx-auto picscanai-logo" style=""
                            src="{{ asset('backend/images/login/picscanai-logo.png') }}" alt=""></a>
                    <h1 class="text-center h5 mt-5 auth-text-primary cubold text-cl text-white login-text">Log In To
                        Your Account</h1>
                    <form method="POST" action="{{ route('cms.login.submit') }}" class="login-form">
                        @csrf
                        <div class="auth-form-input mt-20">
                            {{-- <img class="icon" src="backend/images/icon-user.svg" draggable="false"> --}}
                            <input class="form-control input-style cmn-input" placeholder="Enter User Name"
                                id="email" name="email" type="email" minlength="8" maxlength="30" required
                        ...
                        @if ($errors->has('credentials'))
                            <div class="text-danger text-left mx-3" role="alert">{{ $errors->first('credentials') }}
                            </div>
                        @endif
                        @if (session('status'))
                        ...
                        <div class="text-center mb-2 mt-2 mb-sm-4">

                            <a href="{{ route('cms.forgotPassword.index') }}" class="text-white  fw-300 fs-9">
                                Forget Password?
                        ...
                        <div class="text-white text-center fs-14px fw-300 pt-20px">
                            &copy;
