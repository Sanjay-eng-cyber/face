                    ...
                    <div class="col-12" >
                        <div class="gallery-outer" >
                            ...
                            <div class="gallery-souter" >
                                <img src="{{asset('frontend/images/gallery/bigarrow.svg')}}" alt="" srcset="" class="img-fluid bigarrow-img">
                                <div class="event-detailsbg" style="position: relative">
                                    ...
                                    <div class="row row-cols-1 row-cols-sm-2 row-cols-lg-3 row-cols-xl-4">
                                        <div class="col pb-4">
                                            <div>
                                                <img src="{{asset('frontend/images/eventdetails/1.png')}}" alt="" srcset="" class="img-fluid rounded-3 w-sm-100">
                                            
                                            </div>
                                        </div>
                                        <div class="col pb-4">
                                            <div>
                                                <img src="{{asset('frontend/images/eventdetails/2.png')}}" alt="" srcset="" class="img-fluid rounded-3 w-sm-100">
                                        ...
                                        <div class="col pb-4">
                                            <div>
                                                <img src="{{asset('frontend/images/eventdetails/3.png')}}" alt="" srcset="" class="img-fluid rounded-3 w-sm-100">
                                        ...
                                        <div class="col pb-4">
                                            <div>
                                                <img src="{{asset('frontend/images/eventdetails/4.png')}}" alt="" srcset="" class="img-fluid rounded-3 w-sm-100">
                                        ...
                                        <div class="col pb-4">
                                            <div>
                                                <img src="{{asset('frontend/images/eventdetails/5.png')}}" alt="" srcset="" class="img-fluid rounded-3 w-sm-100">
