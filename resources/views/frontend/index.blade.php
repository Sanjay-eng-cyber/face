...
rev.slick({
        ...
        prevArrow: '<img src="frontend/images/index/left.png" style="cursor:pointer"> ',
        nextArrow: '<img src="frontend/images/index/left.png" style="cursor:pointer;transform:rotate(180deg)"> ',
        infinite: true,
        centerMode: true,
        slidesToShow: 1,
        slidesToScroll: 1,
